        ...
        try (PrintWriter out = response.getWriter()) {
           ...
           String dbUrl="jdbc:mysql://localhost:3306/webbioskop";
            ...
            Connection conn;
             ...
             String izbrisiR= "delete from rezervacija where filmID='"+brisanjeF+ "'";
             Statement stmtR;
             ...
             try {
               ...
               conn = DriverManager.getConnection(dbUrl, user, pass);
                ...
                stmtR.executeUpdate(izbrisiR);
                stmtR.close();
                conn.close();
                
                request.setAttribute("mensa", "Uspesno ste obrisali Film");
             ...
             String izbrisiF= "delete from film where filmID='"+brisanjeF+ "'";
            Statement stmt;
