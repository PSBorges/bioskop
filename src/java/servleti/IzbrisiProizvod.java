 ...
 * @author paulo
 */
public class IzbrisiProizvod extends HttpServlet {
        ...
        try (PrintWriter out = response.getWriter()) {
           ...
           String dbUrl="jdbc:mysql://localhost:3306/webbioskop";
            ...
            try {
                ...
                String izbrisiF= "delete from proizvod where proizvodID='"+brisanjeF+ "'";
                
                stmt.executeUpdate(izbrisiF);
                stmt.close();
                conn.close();
                
                request.setAttribute("mensa", "Uspesno ste obrisali Proizvod");
