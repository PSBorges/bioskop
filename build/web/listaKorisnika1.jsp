<%-- 
    Document   : listaKorisnika1
    Created on : 09-Jan-2021, 09:50:10
    Author     : paulo
--%>
                            ...
                            <table class="table table-striped table-dark table-hover table-bordered align-center">
                                      <thead>
                                        <tr>
                                          ...
                                          <th scope="col">Tip</th>
                                          <th <td class="text-right" colspan="2">Actions</th>
                                        </tr>
                                      </thead>
                                      <tbody>
                                            <% for(Korisnik pom: lista){%>
                                                        <tr>
                                                           ...
                                                           <td class="text-right col-2">
                                                               ...
                                                               <td<p align="right"><a href="AzuriranjeKorisnika?IDK=<%=pom.getKorisnikID()%>"><input type="button" class="btn btn-success badge-pill" style="width:80px" value="Azuriraj"></a></td>
                                                                   <td <p align="right"><a href="IzbrisiKorisnika?ID=<%=pom.getKorisnikID()%>"><input type="button" class="btn btn-danger badge-pill" style="width:80px"class="btn btn-dark badge-pill" style="width:80px" value="Izbrisi"></a> </p></td>
